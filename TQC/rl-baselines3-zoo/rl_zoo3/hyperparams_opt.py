...
def sample_tqc_params(trial: optuna.Trial) -> Dict[str, Any]:
    """
    Sampler for FetchPickAndPlace-v1_1 hyperparams.

    :param trial:
    :return:
    """
    # FetchPickAndPlace-v1_1 is SAC + Distributional RL
...
def sample_qrdqn_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    :return:
    """
    # FetchPickAndPlace-v1_1 is DQN + Distributional RL
...
HYPERPARAMS_SAMPLER = {
    ...
    "FetchPickAndPlace-v1_1": sample_tqc_params,
